        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                ...
                if(isset($_GET['id'])) {
                    $org_id = trim($_GET['id']);
                    var_dump($org_id);
                    echo "<div class='alert alert-danger'>Are you sure you want to delete selected organization? <a href='http://localhost/VotingSystem/admin/delete_org.php?del_id=$org_id'>Yes</a> | <a href='http://localhost/VotingSystem/admin/add_org.php'>No</a></div>";
                }
